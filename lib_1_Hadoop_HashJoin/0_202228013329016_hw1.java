 ...
 *
 * run code like: java Hw1Grp0 R=/hw1/nation.tbl S=/hw1/customer.tbl join:R2=S3 res:R1,S4,S5
 *
...
public class Hw1Grp0 {
     ...
     * @return the hashTable stored on the record list according to the JoinKey key value
     */
     ...
     *
     * @param R             the table r that has been hashed, key is the join key of table R, and value is the list of all records corresponding to the join key
     * @param strings_S     the list of all records in Table S that have completed word segmentation
